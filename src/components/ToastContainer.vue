...
.toast-container {
  ...
  .toast {
    ...
    &.success {
      border: 0.1rem solid $toast-success;
      .toast-header {
        border-bottom: 0.1rem solid $toast-success;
      }
    }

    &.error {
      border: 0.1rem solid $toast-error;
      .toast-header {
        border-bottom: 0.1rem solid $toast-error;
      }
    }

    &.info {
      border: 0.1rem solid $toast-info;
      .toast-header {
        border-bottom: 0.1rem solid $toast-info;
      }
    }
  }
}
